...
=======
/* ADMIN ÌÖåÏù¥Î∏î */
>>>>>>> a123fe2befb2fead857110f57edfd426a137183a
CREATE TABLE ADMIN( 
...
/* REVIEW_COMMENT ≈◊¿Ã∫Ì  */
=======
/* REVIEW_COMMENT ÌÖåÏù¥Î∏î */
=======
/* REVIEW_COMMENT ÔøΩÔøΩÔøΩÃ∫ÔøΩ */
>>>>>>> a4d7ea32a35995832216668873548d1a86830d95
>>>>>>> a123fe2befb2fead857110f57edfd426a137183a
...
INSERT INTO BUSINESS_PARTNER VALUES('BP1', '1111', 'ªÁ¿Â¥‘1', '01000000001', '∂«∫Ò¿∫«‡', '0000000000001', '1', '¿Ã∏ﬁ¿œ1', 0, 1, 0);
INSERT INTO BUSINESS_PARTNER VALUES('BP2', '2222', 'ªÁ¿Â¥‘2', '01000000002', '∂«∫Ò¿∫«‡', '0000000000002', '2', '¿Ã∏ﬁ¿œ2', 0, 1, 0);
INSERT INTO BUSINESS_PARTNER VALUES('BP3', '3333', 'ªÁ¿Â¥‘3', '01000000003', '∂«∫Ò¿∫«‡', '0000000000003', '3', '¿Ã∏ﬁ¿œ3', 0, 1, 0);
INSERT INTO BUSINESS_PARTNER VALUES('BP4', '4444', 'ªÁ¿Â¥‘4', '01000000004', '∂«∫Ò¿∫«‡', '0000000000004', '4', '¿Ã∏ﬁ¿œ4', 0, 1, 0);
INSERT INTO BUSINESS_PARTNER VALUES('BP5', '5555', 'ªÁ¿Â¥‘5', '01000000005', '∂«∫Ò¿∫«‡', '0000000000005', '5', '¿Ã∏ﬁ¿œ5', 0, 1, 0);

INSERT INTO CLIENT VALUES('CL1', 'user1@user.com', '1111', '¥–≥◊¿”1', 'ªÁøÎ¿⁄1', '01010000001', NULL, NULL);
INSERT INTO CLIENT VALUES('CL2', 'user2@user.com', '2222', '¥–≥◊¿”2', 'ªÁøÎ¿⁄2', '01010000002', NULL, NULL);
INSERT INTO CLIENT VALUES('CL3', 'user3@user.com', '3333', '¥–≥◊¿”3', 'ªÁøÎ¿⁄3', '01010000003', NULL, NULL);
INSERT INTO CLIENT VALUES('CL4', 'user4@user.com', '4444', '¥–≥◊¿”4', 'ªÁøÎ¿⁄4', '01010000004', NULL, NULL);
INSERT INTO CLIENT VALUES('CL5', 'user5@user.com', '5555', '¥–≥◊¿”5', 'ªÁøÎ¿⁄5', '01010000005', NULL, NULL);

INSERT INTO HAIR_SALON VALUES('HA1', 'BP1', 'πÃøÎΩ«1', '¡÷º“', '010-0000-0000', '09Ω√~18Ω√', 'πÃøÎΩ« º“∞≥ ≈◊Ω∫∆Æ', 0);
INSERT INTO HAIR_SALON VALUES('HA2', 'BP2', 'πÃøÎΩ«2', '¡÷º“', '010-0000-0000', '09Ω√~18Ω√', 'πÃøÎΩ« º“∞≥ ≈◊Ω∫∆Æ', 0);
INSERT INTO HAIR_SALON VALUES('HA3', 'BP3', 'πÃøÎΩ«3', '¡÷º“', '010-0000-0000', '09Ω√~18Ω√', 'πÃøÎΩ« º“∞≥ ≈◊Ω∫∆Æ', 0);
INSERT INTO HAIR_SALON VALUES('HA4', 'BP4', 'πÃøÎΩ«4', '¡÷º“', '010-0000-0000', '09Ω√~18Ω√', 'πÃøÎΩ« º“∞≥ ≈◊Ω∫∆Æ', 0);
INSERT INTO HAIR_SALON VALUES('HA5', 'BP5', 'πÃøÎΩ«5', '¡÷º“', '010-0000-0000', '09Ω√~18Ω√', 'πÃøÎΩ« º“∞≥ ≈◊Ω∫∆Æ', 0);

INSERT INTO REVIEW VALUES('RV1', 'BP1', 'CL1', '¥–≥◊¿”1', '∏Æ∫‰≥ªøÎ1', NULL, TO_CHAR(SYSDATE, 'YYYYMMDD'), 1);
INSERT INTO REVIEW VALUES('RV2', 'BP1', 'CL2', '¥–≥◊¿”2', '∏Æ∫‰≥ªøÎ2', NULL, TO_CHAR(SYSDATE, 'YYYYMMDD'), 2);
INSERT INTO REVIEW VALUES('RV3', 'BP1', 'CL3', '¥–≥◊¿”3', '∏Æ∫‰≥ªøÎ3', NULL, TO_CHAR(SYSDATE, 'YYYYMMDD'), 3);
INSERT INTO REVIEW VALUES('RV4', 'BP1', 'CL4', '¥–≥◊¿”4', '∏Æ∫‰≥ªøÎ4', NULL, TO_CHAR(SYSDATE, 'YYYYMMDD'), 4);
INSERT INTO REVIEW VALUES('RV5', 'BP1', 'CL5', '¥–≥◊¿”5', '∏Æ∫‰≥ªøÎ5', NULL, TO_CHAR(SYSDATE, 'YYYYMMDD'), 5);
INSERT INTO REVIEW VALUES('RV6', 'BP2', 'CL1', '¥–≥◊¿”1', '∏Æ∫‰≥ªøÎ2-1', NULL, TO_CHAR(SYSDATE, 'YYYYMMDD'), 5);
=======
/* Í∏∞Î≥∏ ?ç∞?ù¥?Ñ∞ */

INSERT INTO BUSINESS_PARTNER VALUES('BP1', '1111', '?Ç¨?û•?ãò1', '01000000001', '?òêÎπÑÏ??ñâ', '0000000000001', '1', '?ù¥Î©îÏùº1', 0, 1, 0);
INSERT INTO BUSINESS_PARTNER VALUES('BP2', '2222', '?Ç¨?û•?ãò2', '01000000002', '?òêÎπÑÏ??ñâ', '0000000000002', '2', '?ù¥Î©îÏùº2', 0, 1, 0);
INSERT INTO BUSINESS_PARTNER VALUES('BP3', '3333', '?Ç¨?û•?ãò3', '01000000003', '?òêÎπÑÏ??ñâ', '0000000000003', '3', '?ù¥Î©îÏùº3', 0, 1, 0);
INSERT INTO BUSINESS_PARTNER VALUES('BP4', '4444', '?Ç¨?û•?ãò4', '01000000004', '?òêÎπÑÏ??ñâ', '0000000000004', '4', '?ù¥Î©îÏùº4', 0, 1, 0);
INSERT INTO BUSINESS_PARTNER VALUES('BP5', '5555', '?Ç¨?û•?ãò5', '01000000005', '?òêÎπÑÏ??ñâ', '0000000000005', '5', '?ù¥Î©îÏùº5', 0, 1, 0);

INSERT INTO CLIENT VALUES('CL1', 'user1@user.com', '1111', '?ãâ?Ñ§?ûÑ1', '?Ç¨?ö©?ûê1', '01010000001', NULL, NULL);
INSERT INTO CLIENT VALUES('CL2', 'user2@user.com', '2222', '?ãâ?Ñ§?ûÑ2', '?Ç¨?ö©?ûê2', '01010000002', NULL, NULL);
INSERT INTO CLIENT VALUES('CL3', 'user3@user.com', '3333', '?ãâ?Ñ§?ûÑ3', '?Ç¨?ö©?ûê3', '01010000003', NULL, NULL);
INSERT INTO CLIENT VALUES('CL4', 'user4@user.com', '4444', '?ãâ?Ñ§?ûÑ4', '?Ç¨?ö©?ûê4', '01010000004', NULL, NULL);
INSERT INTO CLIENT VALUES('CL5', 'user5@user.com', '5555', '?ãâ?Ñ§?ûÑ5', '?Ç¨?ö©?ûê5', '01010000005', NULL, NULL);

INSERT INTO HAIR_SALON VALUES('HA1', 'BP1', 'ÎØ∏Ïö©?ã§1', 'Ï£ºÏÜå1', '010-0000-0000', '09?ãú~18?ãú', 'ÎØ∏Ïö©?ã§ ?ÜåÍ∞? ?Öå?ä§?ä∏1', 0);
INSERT INTO HAIR_SALON VALUES('HA2', 'BP2', 'ÎØ∏Ïö©?ã§2', 'Ï£ºÏÜå2', '010-0000-0000', '09?ãú~18?ãú', 'ÎØ∏Ïö©?ã§ ?ÜåÍ∞? ?Öå?ä§?ä∏2', 0);
INSERT INTO HAIR_SALON VALUES('HA3', 'BP3', 'ÎØ∏Ïö©?ã§3', 'Ï£ºÏÜå3', '010-0000-0000', '09?ãú~18?ãú', 'ÎØ∏Ïö©?ã§ ?ÜåÍ∞? ?Öå?ä§?ä∏3', 0);
INSERT INTO HAIR_SALON VALUES('HA4', 'BP4', 'ÎØ∏Ïö©?ã§4', 'Ï£ºÏÜå4', '010-0000-0000', '09?ãú~18?ãú', 'ÎØ∏Ïö©?ã§ ?ÜåÍ∞? ?Öå?ä§?ä∏4', 0);
INSERT INTO HAIR_SALON VALUES('HA5', 'BP5', 'ÎØ∏Ïö©?ã§5', 'Ï£ºÏÜå5', '010-0000-0000', '09?ãú~18?ãú', 'ÎØ∏Ïö©?ã§ ?ÜåÍ∞? ?Öå?ä§?ä∏5', 0);

INSERT INTO REVIEW VALUES('RV1', 'BP1', 'CL1', '?ãâ?Ñ§?ûÑ1', 'Î¶¨Î∑∞?Ç¥?ö©1', NULL, TO_CHAR(SYSDATE, 'YYYYMMDD'), 1);
INSERT INTO REVIEW VALUES('RV2', 'BP1', 'CL2', '?ãâ?Ñ§?ûÑ2', 'Î¶¨Î∑∞?Ç¥?ö©2', NULL, TO_CHAR(SYSDATE, 'YYYYMMDD'), 2);
INSERT INTO REVIEW VALUES('RV3', 'BP1', 'CL3', '?ãâ?Ñ§?ûÑ3', 'Î¶¨Î∑∞?Ç¥?ö©3', NULL, TO_CHAR(SYSDATE, 'YYYYMMDD'), 3);
INSERT INTO REVIEW VALUES('RV4', 'BP1', 'CL4', '?ãâ?Ñ§?ûÑ4', 'Î¶¨Î∑∞?Ç¥?ö©4', NULL, TO_CHAR(SYSDATE, 'YYYYMMDD'), 4);
INSERT INTO REVIEW VALUES('RV5', 'BP1', 'CL5', '?ãâ?Ñ§?ûÑ5', 'Î¶¨Î∑∞?Ç¥?ö©5', NULL, TO_CHAR(SYSDATE, 'YYYYMMDD'), 5);
INSERT INTO REVIEW VALUES('RV6', 'BP2', 'CL1', '?ãâ?Ñ§?ûÑ1', 'Î¶¨Î∑∞?Ç¥?ö©2-1', NULL, TO_CHAR(SYSDATE, 'YYYYMMDD'), 5);
>>>>>>> a123fe2befb2fead857110f57edfd426a137183a
...
<<<<<<< HEAD
INSERT INTO MESSAGE VALUES('M1', 'æÀ∏≤≥ªøÎ1');
INSERT INTO MESSAGE VALUES('M2', 'æÀ∏≤≥ªøÎ2');
INSERT INTO MESSAGE VALUES('M3', 'æÀ∏≤≥ªøÎ3');
INSERT INTO MESSAGE VALUES('M4', 'æÀ∏≤≥ªøÎ4');
INSERT INTO MESSAGE VALUES('M5', 'æÀ∏≤≥ªøÎ5');

/* ∆˜¿Œ∆Æ  */
INSERT INTO POINT VALUES('PO1', 'ªÁøÎ', 'ªÁøÎ', 0);
INSERT INTO POINT VALUES('PO2', '√Îº“', '√Îº“', 0);
INSERT INTO POINT VALUES('PO3', '±€æ≤±‚', '¿˚∏≥', 100);
INSERT INTO POINT VALUES('PO4', '∏Æ∫‰', '¿˚∏≥', 300);

/* ∏∂¿Ã∆˜¿Œ∆Æ */
INSERT INTO MYPOINT VALUES('CL1', 'PO4', SEQ_MYPOINT.NEXTVAL, TO_CHAR(SYSDATE, 'YYYYMMDD'), '¿˚∏≥', 'πÃøÎΩ«1', 'RV1', 500, 500);
INSERT INTO MYPOINT VALUES('CL1', 'PO4', SEQ_MYPOINT.NEXTVAL, TO_CHAR(SYSDATE, 'YYYYMMDD'), '¿˚∏≥', 'πÃøÎΩ«2', 'RV6', 500, 1000);
INSERT INTO MYPOINT VALUES('CL1', 'PO1', SEQ_MYPOINT.NEXTVAL, TO_CHAR(SYSDATE, 'YYYYMMDD'), 'ªÁøÎ', 'πÃøÎΩ«3', 'HAP1', -1000, 0);
INSERT INTO MYPOINT VALUES('CL1', 'PO2', SEQ_MYPOINT.NEXTVAL, TO_CHAR(SYSDATE, 'YYYYMMDD'), '√Îº“', 'πÃøÎΩ«3', 'HAP1', 1000, 1000);
=======
INSERT INTO MESSAGE VALUES('M1', '?ïåÎ¶ºÎÇ¥?ö©1');
INSERT INTO MESSAGE VALUES('M2', '?ïåÎ¶ºÎÇ¥?ö©2');
INSERT INTO MESSAGE VALUES('M3', '?ïåÎ¶ºÎÇ¥?ö©3');
INSERT INTO MESSAGE VALUES('M4', '?ïåÎ¶ºÎÇ¥?ö©4');
INSERT INTO MESSAGE VALUES('M5', '?ïåÎ¶ºÎÇ¥?ö©5');

/* ?è¨?ù∏?ä∏ */
INSERT INTO POINT VALUES('PO1', '?Ç¨?ö©', '?Ç¨?ö©', 0);
INSERT INTO POINT VALUES('PO2', 'Ï∑®ÏÜå', 'Ï∑®ÏÜå', 0);
INSERT INTO POINT VALUES('PO3', 'Í∏??ì∞Í∏?', '?†ÅÎ¶?', 100);
INSERT INTO POINT VALUES('PO4', 'Î¶¨Î∑∞', '?†ÅÎ¶?', 300);

/* ÎßàÏù¥?è¨?ù∏?ä∏ */
INSERT INTO MYPOINT VALUES('CL1', 'PO4', SEQ_MYPOINT.NEXTVAL, TO_CHAR(SYSDATE, 'YYYYMMDD'), '?†ÅÎ¶?', 'ÎØ∏Ïö©?ã§1', 'RV1', 500, 500);
INSERT INTO MYPOINT VALUES('CL1', 'PO4', SEQ_MYPOINT.NEXTVAL, TO_CHAR(SYSDATE, 'YYYYMMDD'), '?†ÅÎ¶?', 'ÎØ∏Ïö©?ã§2', 'RV6', 500, 1000);
INSERT INTO MYPOINT VALUES('CL1', 'PO1', SEQ_MYPOINT.NEXTVAL, TO_CHAR(SYSDATE, 'YYYYMMDD'), '?Ç¨?ö©', 'ÎØ∏Ïö©?ã§3', 'HAP1', -1000, 0);
INSERT INTO MYPOINT VALUES('CL1', 'PO2', SEQ_MYPOINT.NEXTVAL, TO_CHAR(SYSDATE, 'YYYYMMDD'), 'Ï∑®ÏÜå', 'ÎØ∏Ïö©?ã§3', 'HAP1', 1000, 1000);
>>>>>>> a123fe2befb2fead857110f57edfd426a137183a
