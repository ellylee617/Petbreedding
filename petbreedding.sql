...
CREATE TABLE HAIR_SALON_IMG (
    IMG_NUM PRIMARY KEY VARCHAR2(20),
...
CREATE TABLE HOSPITAL (
    ...
    HOS_DINFO VARCHAR2(3000) NOT NULL,
    HOS_CONN VARCHAR2(20) NOT NULL,
    HOS_CLICK NUMBER(7) NOT NULL,
    Y VARCHAR2(20) NOT NULL,
    X VARCHAR(20 NOT NULL,
    HOS_MIMG VARCHAR(20 NOT NULL
);
...
INSERT INTO BUSINESS_PARTNER VALUES('BP1', '1111', '사장님1', '01000000001', '또비은행', '0000000000001', '1', '이메일1', 0, 1, 0);
INSERT INTO BUSINESS_PARTNER VALUES('BP2', '2222', '사장님2', '01000000002', '또비은행', '0000000000002', '2', '이메일2', 0, 1, 0);
INSERT INTO BUSINESS_PARTNER VALUES('BP3', '3333', '사장님3', '01000000003', '또비은행', '0000000000003', '3', '이메일3', 0, 1, 0);
INSERT INTO BUSINESS_PARTNER VALUES('BP4', '4444', '사장님4', '01000000004', '또비은행', '0000000000004', '4', '이메일4', 0, 1, 0);
INSERT INTO BUSINESS_PARTNER VALUES('BP5', '5555', '사장님5', '01000000005', '또비은행', '0000000000005', '5', '이메일5', 0, 1, 0);

INSERT INTO CLIENT VALUES('CL1', 'user1@user.com', '1111', '닉네임1', '사용자1', '01010000001', NULL, NULL);
INSERT INTO CLIENT VALUES('CL2', 'user2@user.com', '2222', '닉네임2', '사용자2', '01010000002', NULL, NULL);
INSERT INTO CLIENT VALUES('CL3', 'user3@user.com', '3333', '닉네임3', '사용자3', '01010000003', NULL, NULL);
INSERT INTO CLIENT VALUES('CL4', 'user4@user.com', '4444', '닉네임4', '사용자4', '01010000004', NULL, NULL);
INSERT INTO CLIENT VALUES('CL5', 'user5@user.com', '5555', '닉네임5', '사용자5', '01010000005', NULL, NULL);

INSERT INTO HAIR_SALON VALUES('HA1', 'BP1', '미용실1', '주소1', '010-0000-0000', '09시~18시', '미용실 소개 테스트1', 0);
INSERT INTO HAIR_SALON VALUES('HA2', 'BP2', '미용실2', '주소2', '010-0000-0000', '09시~18시', '미용실 소개 테스트2', 0);
INSERT INTO HAIR_SALON VALUES('HA3', 'BP3', '미용실3', '주소3', '010-0000-0000', '09시~18시', '미용실 소개 테스트3', 0);
INSERT INTO HAIR_SALON VALUES('HA4', 'BP4', '미용실4', '주소4', '010-0000-0000', '09시~18시', '미용실 소개 테스트4', 0);
INSERT INTO HAIR_SALON VALUES('HA5', 'BP5', '미용실5', '주소5', '010-0000-0000', '09시~18시', '미용실 소개 테스트5', 0);

INSERT INTO REVIEW VALUES('RV1', 'BP1', 'CL1', '닉네임1', '리뷰내용1', NULL, TO_CHAR(SYSDATE, 'YYYYMMDD'), 1);
INSERT INTO REVIEW VALUES('RV2', 'BP1', 'CL2', '닉네임2', '리뷰내용2', NULL, TO_CHAR(SYSDATE, 'YYYYMMDD'), 2);
INSERT INTO REVIEW VALUES('RV3', 'BP1', 'CL3', '닉네임3', '리뷰내용3', NULL, TO_CHAR(SYSDATE, 'YYYYMMDD'), 3);
INSERT INTO REVIEW VALUES('RV4', 'BP1', 'CL4', '닉네임4', '리뷰내용4', NULL, TO_CHAR(SYSDATE, 'YYYYMMDD'), 4);
INSERT INTO REVIEW VALUES('RV5', 'BP1', 'CL5', '닉네임5', '리뷰내용5', NULL, TO_CHAR(SYSDATE, 'YYYYMMDD'), 5);
INSERT INTO REVIEW VALUES('RV6', 'BP2', 'CL1', '닉네임1', '리뷰내용2-1', NULL, TO_CHAR(SYSDATE, 'YYYYMMDD'), 5);
...
INSERT INTO MESSAGE VALUES('M1', '알림내용1');
INSERT INTO MESSAGE VALUES('M2', '알림내용2');
INSERT INTO MESSAGE VALUES('M3', '알림내용3');
INSERT INTO MESSAGE VALUES('M4', '알림내용4');
INSERT INTO MESSAGE VALUES('M5', '알림내용5');

/* 포인트 */
INSERT INTO POINT VALUES('PO1', '사용', '사용', 0);
INSERT INTO POINT VALUES('PO2', '취소', '취소', 0);
INSERT INTO POINT VALUES('PO3', '글쓰기', '적립', 100);
INSERT INTO POINT VALUES('PO4', '리뷰', '적립', 300);

/* 마이포인트 */
INSERT INTO MYPOINT VALUES('CL1', 'PO4', SEQ_MYPOINT.NEXTVAL, TO_CHAR(SYSDATE, 'YYYYMMDD'), '적립', '미용실1', 'RV1', 500, 500);
INSERT INTO MYPOINT VALUES('CL1', 'PO4', SEQ_MYPOINT.NEXTVAL, TO_CHAR(SYSDATE, 'YYYYMMDD'), '적립', '미용실2', 'RV6', 500, 1000);
INSERT INTO MYPOINT VALUES('CL1', 'PO1', SEQ_MYPOINT.NEXTVAL, TO_CHAR(SYSDATE, 'YYYYMMDD'), '사용', '미용실3', 'HAP1', -1000, 0);
