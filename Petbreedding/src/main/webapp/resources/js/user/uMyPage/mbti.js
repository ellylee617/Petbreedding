...
const infoList = [
  ...
  },
  {
    ...
    desc: '친화력이 뛰어나고 일상적인 활동엔 지루함을 느껴요 ㅠ.ㅠ<br>  누굴 만나든, 누구랑 있든 똥꼬발랄 그 자체 댕댕이라 주인님이 감당하기 힘들 수도 있어요 ~ '
  },
  {
  ...
  },
  {
    ...
    desc: '본인이 해야할 일에 철저한 준비를 거쳐야 행동으로 옮기는 댕댕이에요 !!<br>  또한 굉장히 활동적이고 주인님이 시키는 재롱을 다 하지만 단호할 땐 엄청 단호한 댕댕이 랍니다!! '
  },
]
