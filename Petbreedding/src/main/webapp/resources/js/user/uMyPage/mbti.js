...
const infoList = [
  {
    ...
    desc: '첵임감이 강해서 사고를 잘 안치는 댕댕이에요~ 매사에 철저하고 보수적이라 주인님 속 썩을 일이 잘 없답니다!'
  },
  {
    name: 'ISFI 차분한 진국 댕댕이',
    desc: '차분하고 주인님만 바라보는 헌신적인 댕댕이에요~ 인내심이 강해서 주인님이 어떤 장난을 쳐도 잘 받아준답니다. 또한 주인님이 슬프면 나도 슬픈 프로 감정러에요~ '
  },
  {
    name: 'INFJ 모두 다같이 즐거운게 중요한 댕댕이',
    desc: '통찰력이 뛰어난 댕댕이라 사람들에게 칭찬을 많이 받아요~ 혼자 잘 먹고 잘 사는 것 보다 모든 댕댕이들의 행복을 빌어요!'
  },
  {
    name: 'INTJ 독립적인 댕댕이',
    desc: '의지가 강하고 독립적인 댕댕이라 가끔 주인님이 다른 일을 하고 관심에 소홀하다해도 크게 신경쓰지 않아요~ 분석력이 뛰어난 댕댕이라 항상 주인님을 분석하고 있답니다'
  },
  {
    name: 'ISTP 과묵한 댕댕이',
    desc: '이 댕댕이는 너무 과묵해서 주인님이 애교 시켜도 잘 안부려요 ㅠㅠ 손 ! 코 ! 빵 ! 해도 묵묵부답... 하지만 어디서든 적응을 잘 하는 똑똑한 댕댕이랍니다.'
  },
  {
    name: 'ISFP 이 순간 내가 제일 여유로운 댕댕이 ',
    desc: '성격이 너무 온화해서 웬만하면 잘 짖지 않아요~~ 또한 삶의 여유를 만끽할 수 있는 욜로 댕댕이랍니다'
  },
  {
    name: 'INFP 성실하고 이해심 넘치는 슈퍼 감성댕댕이',
    desc: '어떤 댕댕이보다도 주인님에 대한 이해심이 많고 개방적이라 혼자 상상도 많이해요~ 감정을 주인님한테 잘 표현하진 않지만 어떤 댕댕이보다도 내적 신념이 강하답니다!!'
  },
  {
    name: 'INTP 나는 호기심 대마왕 댕댕이',
    desc: '호기심이 많아서 이것 저것 다 해보는 댕댕이라 가끔 주인님한테 혼날 때도 많아요 ㅠㅠ'
  },
  {
    name: 'ESTP 프로 느긋러 댕댕이',
    desc: '매사에 느긋느긋하고 관용적이라 주인님과 타협을 잘해요~~ 주인님이 간식 주면 나도 재롱 부려요~'
  },
  {
    name: 'ESFP 프로 경험러 댕댕이',
    desc: '호기심이 많아서 이것 저것 다 경험해보고 싶어요 ~~ 낯선 곳을 가도 잘 적응할 수 있는 나는야 호기심 대마왕 댕댕이 입니다. '
  },
  {
    name: 'ENFP 사교성 대마왕 똥꼬발랄 댕댕이',
    desc: '친화력이 뛰어나고 일상적인 활동엔 지루함을 느껴요 ㅠ.ㅠ 누굴 만나든, 누구랑 있든 똥꼬발랄 그 자체 댕댕이라 주인님이 감당하기 힘들 수도 있어요 ~ '
  },
  {
    name: 'ENTP 독창적이고 똑똑한 댕댕이',
    desc: '하고 싶은 건 무조건 해야 직성이 풀려요 ! 어떻게 사고를 이렇게 독창적으로 칠 수 있지... 하는 생각이 들게 하는 댕댕이랍니다 :) '
  },
  {
    name: 'ESTJ 규칙을 잘 지키는 댕댕이',
    desc: '주인님 말이 곧 법 !! 주인님 말을 가장 잘 듣는 댕댕이에요~ 하지만 본인이 받아야 하는 게 있으면 무조건 받아야 하는 댕댕이랍니다  '
  },
  {
    name: 'ESFI 사람이 너무 좋은 댕댕이',
    desc: '어린이랑도 잘 지내고 낯선 사람에게도 친절한 댕댕이에요~ 반려인과의 관계에서 행복을 느끼고 리액션이 정말 풍부해요 !! 반려인이 바쁘면 토라져서 달래줘야 할 수도 있답니다 !! '
  },
  {
    name: 'ENFJ 사교적이지만 날 혼내면 짖는 댕댕이',
    desc: '처음 만나는 댕댕이 친구와도 금방 친해지고 어린이랑도 잘 지내는 사교적인 댕댕이지만, 혼내면 으르렁 거려 가끔 무서운 댕댕이에요~ 하지만 따끔하게 혼내야 한다는 거 !! '
  },
  {
    name: 'ENTJ 준비성 철저 댕댕이',
    desc: '본인이 해야할 일에 철저한 준비를 거쳐야 행동으로 옮기는 댕댕이에요 !! 또한 굉장히 활동적이고 주인님이 시키는 재롱을 다 하지만 단호할 땐 엄청 단호한 댕댕이 랍니다!! '
  },
]
