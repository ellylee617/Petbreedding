...
function connect() {
	sock = new SockJS("http://localhost:8090/petbreedding/bchat/");
		...
		$("#chatMessageArea")
				.append(
						"<div class='col-12 row dMessageO'><div class='col-2 dMessage my'><div class='dNick'>"
								+ name + "</div></div><br><div class='col-10 dConO my'><div class='col-12 dConI mycolor'><span>"
								+ msg + "</span></div><div class='col-12 dTimeO'><br><div>"
								+ t + "</div></div></div></div><br><br><br><br>")
