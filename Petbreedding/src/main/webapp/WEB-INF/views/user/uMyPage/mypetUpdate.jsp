...
<body>
	<div class="wrapper">
		...
		<jsp:include page="../myPageAside.jsp" />
            <form action="${path}/Mypage/petupdate" method="POST" id="petInfoFrm" class="petInfo_container" enctype="multipart/form-data">
                ...
                <table class="petInfo_container">
                    <tr>
                        <td colspan="2" class="imgTd">
                            <div class="imgContainer">
                                <div class="imgBox">
                                    <img src="${path}/resources/uploadFile/mypet/${list.pet_img}" width="150" height="150">
                                </div>
                    ...
                    <tr>
                        <td colspan="2">
                            <input type="text" placeholder="${list.pet_name}" class="basicTextInput m_20 mt_20" name="pet_name" id="pet_name"
                            value="${list.pet_name}">
                    ...
                    <tr>
                        <td colspan="2" class="radioBox">
                            <ul class="selectOpt">
                                <input type="checkbox" id="skin" name="others" value="skin">
                                <li class="otherslist">
                                    <label for="skin">피부병</label><br>
                                </li>
                                <input type="checkbox" id="heart" name="others" value="heart">
                                <li class="otherslist">
                                    <label for="heart">심장질환</label><br>
                                </li>
                                <input type="checkbox" id="marking" name="others" value="marking">
                                <li class="otherslist">
                                    <label for="marking">마킹</label>
                                </li>
                                <li class="otherslist otherslistL m_10">
                                    <input type="checkbox" id="moutinung" name="others" value="moutinung">
