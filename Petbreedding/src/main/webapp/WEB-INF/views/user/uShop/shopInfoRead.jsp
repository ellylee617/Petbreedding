...
<link href="${path}/resources/css/shop/shopInfoRead.css" rel="stylesheet" type="text/css" >
...
<body>
	<div class="wrapper">    
	 ...
	 <!-- script -->
     <script type="text/javascript" src="${path}/resources/js/shop/shopInfoRead.js"></script>
