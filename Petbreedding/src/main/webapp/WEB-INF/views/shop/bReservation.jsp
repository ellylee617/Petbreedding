...
<link href="${path}/resources/css/shop/bReservation.css" rel="stylesheet" type="text/css" >
...
<body>
    ...
    <script type="text/javascript" src="${path}/resources/js/shop/bReservation.js"></script>	
</body>
</html>