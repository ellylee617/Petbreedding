...
<link href="${path}/resources/css/footer.css" rel="stylesheet"
	type="text/css">
<link href="${path}/resources/css/mypage/mAside.css" rel="stylesheet"
	type="text/css">
<link href="${path}/resources/css/mypage/mservice.css" rel="stylesheet"
	type="text/css">
...
<body>
	...
	<script type="text/javascript"
		src="${path}/resources/js/mypage/mAside.js"></script>
</body>
</html>