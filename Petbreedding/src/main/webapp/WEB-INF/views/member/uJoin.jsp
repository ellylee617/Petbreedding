...
<link href="${path}/resources/css/member/uJoin.css" rel="stylesheet" type="text/css">
...
<body>
        ...
        <section class="section">
            <form action="" id="joinFrm" class="joinFrm">
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2">
                            <input type="text" class="basicTextInput" id="pwd" required>
                    ...
                    <tr>
                        <td colspan="2">
                            <input type="text" class="basicTextInput" id="pwdCheck" required>
                    ...
                    <tr>
                        <td>
                            <input type="text" placeholder="ex) 010-1234-1234" id="hp" class="getChkMsg_bar basicTextInput" required>                            
                        </td>
                        <td>
    ...
    <!-- script -->
	<script type="text/javascript" src="${path}/resources/js/member/uJoin.js"></script>
</body>
</html>